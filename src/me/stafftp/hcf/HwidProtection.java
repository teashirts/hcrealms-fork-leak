...
public class HwidProtection {
    ...
    private String securityKey = "asdkjfaskjdfhaksjdhfjkashdfkjhasdkjfsdkfasjf";
    ...
    public boolean register(){
        ...
        if(vt == ValidationType.VALID){
            ...
            log(1, ChatColor.BLUE + "Enjoy fHCf, Any bugs report them to Tristan!");
            log(0, ChatColor.YELLOW.toString() + "------------------------------");
            return true;
        }else{
            /*
            ...
            log(1, ChatColor.BLUE + "If you think this is a mistake contact Tristan");
            log(0, ChatColor.YELLOW.toString() + "------------------------------");
