...
public class Buy1Get1Timer extends GlobalTimer implements Listener {

	@SuppressWarnings("unused")
	private final Base plugin;
	
	public Buy1Get1Timer(Base plugin) {
		super("Buy-1-Get-1",  TimeUnit.SECONDS.toMillis(1L));
		this.plugin = plugin;
	}
	...
	public void onExpire(TimerExpireEvent event) {
		if (event.getTimer() == this) {
			Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "broadcast &7The &a&lBuy1Get1 Event &7has ended.");
		}
	}
