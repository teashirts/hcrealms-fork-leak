...
public class DoubleKeyListener implements Listener {
    ...
    public static class RebootRunnable extends BukkitRunnable {
        ...
        private DoubleKeyListener rebootTimer;
        private long startMillis;
        private static long endMillis;

        @SuppressWarnings("static-access")
		public RebootRunnable(DoubleKeyListener rebootTimer, long duration) {
