...
public class FlashSaleListener implements Listener {
    ...
    public static class RebootRunnable extends BukkitRunnable {
        ...
        private FlashSaleListener rebootTimer;
        private long startMillis;
        private static long endMillis;

        @SuppressWarnings("static-access")
		public RebootRunnable(FlashSaleListener rebootTimer, long duration) {
