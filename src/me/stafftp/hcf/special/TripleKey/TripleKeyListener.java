...
public class TripleKeyListener implements Listener {
    ...
    public static class RebootRunnable extends BukkitRunnable {
        ...
        private TripleKeyListener rebootTimer;
        private long startMillis;
        private static long endMillis;

        @SuppressWarnings("static-access")
		public RebootRunnable(TripleKeyListener rebootTimer, long duration) {
