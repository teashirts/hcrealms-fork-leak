...
public class Kit
{
    ...
    public static void giveDonatorKit(final Player p) {
        final PlayerInventory inv = p.getInventory();
        inv.clear();
        inv.clear();
        p.getActivePotionEffects().clear();
        ...
        helmet.addEnchantment(Enchantment.DURABILITY, 4);
        final ItemStack chest = new ItemStack(Material.DIAMOND_CHESTPLATE);
        chest.addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 2);
        chest.addEnchantment(Enchantment.DURABILITY, 4);
        final ItemStack leggings = new ItemStack(Material.DIAMOND_LEGGINGS);
        leggings.addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 2);
        leggings.addEnchantment(Enchantment.DURABILITY, 4);
        final ItemStack boots = new ItemStack(Material.DIAMOND_BOOTS);
        boots.addEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 2);
        boots.addEnchantment(Enchantment.DURABILITY, 4);
        boots.addEnchantment(Enchantment.PROTECTION_FALL, 4);
        final ItemStack sword = new ItemStack(Material.DIAMOND_SWORD);
        sword.addEnchantment(Enchantment.DAMAGE_ALL, 2);
        sword.addEnchantment(Enchantment.DURABILITY, 4);
