    ...
    public void onclicksigncrowbarbuy(final PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (state instanceof Sign) {
                ...
                else if (s.getLine(0).equals(ChatColor.translateAlternateColorCodes('&', "&9[Kit]")) && s.getLine(1).equals("Donator")) {
                	Kit.giveDonatorKit(p);
                	p.sendMessage(ChatColor.GREEN + "You have received your Donator kit.");
                }
            }
        }
    }
